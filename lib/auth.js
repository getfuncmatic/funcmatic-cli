...
const FuncmaticAPIBaseURL = process.env.FUNCMATIC_API_BASEURL || "https://api.funcmatic.com/dev"
const UserPoolId = process.env.AWS_COGNITO_USERPOOLID || 'us-west-2_eJTw2dsFU' 
const ClientId = process.env.AWS_COGNITO_CLIENTID || '5a7rgt4jcbgqju20knmv5lu189' 
const IdentityPoolId = process.env.AWS_COGNITO_IDENTITYPOOLI || 'us-west-2:c7dc3929-c6ab-4293-9d06-e9cee921ca0f' 
